...
TEST_P(EvalTestFixture, CheckDraws) {
    ...
    EXPECT_EQ(testCase.eval, game.board.eval)
        << "Failed at fen: " << testCase.fen << "Test Case eval: " << game.board.eval << "excepted: " << testCase.eval
        << std::endl;
    ...
    EXPECT_EQ(initialEval, game.board.eval) << "Failed at fen: " << testCase.fen << "Initial eval " << initialEval
                                            << " eval after unmaking: " << game.board.eval << std::endl;
}

INSTANTIATE_TEST_SUITE_P(
    Positions, EvalTestFixture,
    ::testing::Values(
        ...
        Position{"r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1", "e2a6 c7c5 d5c6 a8b8 c6c7",
                 550},
        Position{"r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1",
                 "e2a6 c7c5 d5c6 a8b8 c6c7 f6e4", 420},
        Position{"r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1",
                 "e2a6 c7c5 d5c6 a8b8 c6c7 f6e4 c7b8q", 1660},
        Position{STARTING_FEN, "", 0}, Position{"5k2/8/8/8/8/8/P7/2K5 w - - 0 1", "a2a4", PieceValues[Pawn]},
