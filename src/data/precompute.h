...
constexpr std::array<int, 64> pawnPieceSquares = {0,  0,  0,   0,  0,  0,   0,  0,  5,  10, 10, -20, -20, 10, 10, 5,
...
inline int evaluatePieceSquare(int pieceType, int square, bool isWhite, bool isEndgame = false) {
    ...
    switch (pieceType) {
        ...
        case Queen:
            ...
            break;
        case King:
            value = isEndgame ? precomputedData::kingEndPieceSquares[tableSquare]
                              : precomputedData::kingMiddlePieceSquares[tableSquare];
            break;
        case None:
            value = 0;
    }
